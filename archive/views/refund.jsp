            ...
            <div class="container">
                ...
                <div class="content-heading clearfix">
                    <div class="heading-left">
                        <h1 class="page-title-st">Refund</h1>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-main">
                        <div class="panel-heading">
                            <h3 class="panel-title">Create a Refund</h3>
                                    ...
                                    <div class="row" style="margin: 0 0 0 -10px !important;;">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label">charge</label>
                                                <div class="col-sm-7">
                                                    <form:input path="charge" class="form-control" id="charge" value="${refundReq.charge}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label">refund_application_fee</label>
                                                <div class="col-sm-7">
                                                    <form:select path="refund_application_fee" id="refundAppFee" class="form-control" itemValue="${refundReq.refund_application_fee}" >
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label">reverse_transfer</label>
                                                <div class="col-sm-7">
                                                    <form:select path="reverse_transfer" id="reverseTransfer" class="form-control" itemValue="${refundReq.reverse_transfer}" >
                                                        <form:option value="true" label="true"/>
                                                        <form:option value="false" label="false"/>
                                                    </form:select>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <form:select path="reason" id="reason" class="form-control" itemValue="${refundReq.reason}" >
                                                        <form:option value="" label="--------"/>
                                                        <form:option value="requested_by_customer" label="requested_by_customer"/>
                                                        <form:option value="fraudulent" label="fraudulent"/>
                                                        <form:option value="duplicate" label="duplicate"/>
                                                    </form:select>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    $(function()
    {
        ...
        $('#navCreateRefund').toggleClass('active');
