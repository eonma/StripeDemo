            ...
            <div class="container">
                ...
                <div class="content-heading clearfix">
                    <div class="heading-left">
                        <h1 class="page-title-st">Capture a PaymentIntent</h1>
                    </div>
                    <!-- Account selection -->
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Capture a PaymentIntent</li>
                    </ul>
                </div>
                <!-- END HEADING AND BREADCRUMB -->

                <!-- SERVER SIDE PANEL - Capture PI -->
                <div class="row" id="capture-params">
                    <div class="panel panel-main panel-server panel-tab">
                        <div class="panel-heading">
                            <span class="client-server stripe-blue">SERVER</span>
                            <a name="server"><h3 class="panel-title"><span class="label label-success api-method">POST</span>/v1/payment_intents/:id/capture</h3></a>
...
<script>
    $(function(){
        ...
        $('#navCapturePi').toggleClass('active');
        ...
        $('#pi-capture-btn').on('click', function () {
            ...
            $('#pi-capture-btn').append("<i class=\"fa fa-spinner fa-spin pi-btn-spinner\"></i>");
            $('#pi-capture-btn').prop('disabled', true);
