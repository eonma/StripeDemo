                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${pi.status == 'requires_source'}">
                                            ...
                                            <c:when test="${pi.status == 'requires_source'}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="saveToCustomer"/> Save source to Customer
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                onBeforeOpen: (
                    Swal.showLoading(),
                        function(){
                            $.ajax({
                                type : "GET",
                                url : "https://api.stripe.com/v1/payment_intents/" + piId,
