...
/*Remove this function from orderingjs as its not included in homepage*/
/*CI-510*/
(function($, window, document, undefined){
	window.Basket = {
			...
			buyProduct : function(prdCode,basketType, quantity){
				...
				//remove this function as no CI-510 cro requirement to capture detail only from detail page as discussed with cro team
				var controllerRestrict= $('#controller').val();
				// if(controllerRestrict!=undefined && controllerRestrict!='' && controllerRestrict!="homecontroller"){
				if(controllerRestrict!="homecontroller"){                     
